                            ...
                            <div class="page-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card widget-card-1">
                                            <div class="card-block-small">
                                                <i class="icofont icofont-user-alt-3 bg-c-blue card1-icon"></i>
                                                <span class="text-c-blue f-w-600">Jumlah <br> User</span>
                                                <h4><?=$jUser->hasil ?></h4>
                                                <!-- <div>
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card widget-card-1">
                                            <div class="card-block-small">
                                                ...
                                                <span class="text-c-pink f-w-600">Jumlah <br> Produk</span>
                                                <h4><?=$jProduk->hasil ?></h4>
                                                <!-- <div>
                                                    <span class="f-left m-t-10 text-muted">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card widget-card-1">
                                            <div class="card-block-small">
                                                ...
                                                <span class="text-c-green f-w-600">Jumlah <br> Kupon Diskon</span>
                                                <h4><?=$jDiskon->hasil ?></h4>
                                                <!-- <div>
                                                    <span class="f-left m-t-10 text-muted">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="card widget-card-1">
                                            <div class="card-block-small">
                                                <i class="ti-menu-alt bg-c-yellow card1-icon"></i>
                                                <span class="text-c-yellow f-w-600">Jumlah <br> Kategori Produk</span>
                                                <h4><?=$jKategori->hasil ?></h4>
                                                <!-- <div>
                                                    <span class="f-left m-t-10 text-muted">
                                                ...
                                                <div class="to-do-list">
                                                    <div class="checkbox-fade fade-in-primary d-block">
                                                        <label class="check-task d-block">
                                                            ...
                                                            <div class="task-card-img m-l-40">
                                                                <a href="#!"><img src="<?=base_url()?>assets/dashboard/images/avatar-2.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                                                <a href="#!"><img src="<?=base_url()?>assets/dashboard/images/avatar-3.jpg" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                                                <a href="#!"><img src="<?=base_url()?>assets/dashboard/images/avatar-4.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                                                <a href="#!"><img src="<?=base_url()?>assets/dashboard/images/avatar-2.jpg" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                                            </div>
                                                        </label>
                                                    </div>
                                                </div>
