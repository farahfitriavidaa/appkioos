            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" action="<?=base_url()?>Login/loginakun" method="POST">
                            ...
                            <div class="auth-box">
                                ...
                                <hr/>
                                <span style="color:black">Belum mempunyai akun? <a href="<?=base_url()?>Register">Registrasi Sekarang</a> </span>
                            </div>
                        </form>
                        <!-- end of form -->
                    </div>
